  ...
  if (questions.length > 0 && currentQuestionIndex < questions.length) {
    return (
      <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => setSelectedDifficulty('easy')}>
              <Text style={styles.buttonText}>easy</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.button} onPress={() => setSelectedDifficulty('medium')}>
              <Text style={styles.buttonText}>medium</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.button}onPress={() => setSelectedDifficulty('hard')}>
